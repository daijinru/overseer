"""Centralized logging configuration for the Overseer application."""
...
_TOOL_LOGGER_NAME = "overseer.tool_results"


def setup_logging(log_dir: Path | None = None) -> None:
    """Configure logging for the entire application.

    Call once at startup before OverseerApp is created.
    """
    ...
    app_handler = logging.handlers.TimedRotatingFileHandler(
        filename=str(base_dir / "overseer.log"),
        when="midnight",
        interval=1,
        backupCount=14,
        encoding="utf-8",
